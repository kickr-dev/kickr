...
type Kickr struct {
	...
	// CI enables Continuous Integration / Deployment / Delivery jobs and actions.
...
// CI enables Continuous Integration / Deployment / Delivery jobs and actions.
type CI struct {
	// Provider defines the Continuous Integration / Deployment / Delivery provider.
	//
	// Enums:
	//  - github
	//  - gitlab
	...
	// Options defines available options to tune CI/CD behaviors.
